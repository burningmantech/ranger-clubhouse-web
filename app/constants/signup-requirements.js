...
export const REQUIREMENT_LABELS = {
  ...
  [OT_DISABLED]: 'The Online Course has to be completed. However, the course is not quite ready yet and usually available by mid-to-late March. Watch the Ranger Announce mailing list for a message on when the course will be available.',
  [OT_MISSING]: 'The Online Course has not been completed.',
