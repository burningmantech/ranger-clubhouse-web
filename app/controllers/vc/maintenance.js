...
export default class VcMaintenanceController extends ClubhouseController {
  ...
  tasks = [
    ...
    },
    {
      ...
      description: 'For individuals who have claimed a ticket or SAP, OR who have signed up an In-Person Training, set BMID titles for Shift Leads, OODs, Operations Managers, Department Managers, LEALs, and 007s.',
      controller: 'bmid',
