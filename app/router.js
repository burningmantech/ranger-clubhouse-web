...
Router.map(function () {
  ...
  this.route('authenticated', {path: ''}, function () {
    ...
    this.route('hq', {resetNamespace: true, path: '/hq/:person_id'}, function () {
      this.route('index', {path: '/'});
      this.route('assets');
      this.route('messages');
      this.route('schedule');
    ...
    this.route('mentor', {resetNamespace: true}, function () {
    ...
    this.route('person', {resetNamespace: true, path: '/person/:person_id'}, function () {
      this.route('index', {path: '/'});
    ...
    this.route('training', {resetNamespace: true, path: '/training/:position_id'}, function () {
      this.route('index', {path: '/'});
    ...
    this.route('vc', {resetNamespace: true}, function () {
