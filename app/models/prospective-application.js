...
export const StatusColors = {
  ...
  [STATUS_CREATED]: 'success',
  [STATUS_DUPLICATE]: 'danger',
  [STATUS_HANDLE_CHECK]: 'gray',
  [STATUS_HOLD_AGE_ISSUE]: 'warning',
  [STATUS_HOLD_MORE_HANDLES]: 'warning',
  [STATUS_HOLD_QUALIFICATION_ISSUE]: 'warning',
  [STATUS_HOLD_RRN_CHECK]: 'warning',
  [STATUS_HOLD_WHY_RANGER_QUESTION]: 'warning',
  [STATUS_PENDING]: 'info',
  [STATUS_PII_ISSUE]: 'warning',
  [STATUS_REJECT_PRE_BONK]: 'danger',
  [STATUS_REJECT_REGIONAL]: 'danger',
  [STATUS_REJECT_RETURNING_RANGER]: 'danger',
  [STATUS_REJECT_TOO_YOUNG]: 'danger',
  [STATUS_REJECT_UBERBONKED]: 'danger',
  [STATUS_REJECT_UNQUALIFIED]: 'danger',
};
